...
public class HapticGrabber : MonoBehaviour 
{
    ...
    public static Collider manuelCol;                  // Juste pour voir si je peux me démerder à partir du parent vu que ca marche pas pour les gosses
	...
	void FixedUpdate () 
	{
		...
		if (grabbing)
			...
			*/
        /*
        if(grabbing && newButtonStatus == true)
        {
    ...
    public bool ButtonStatusReturned()
    {
        return (buttonStatus);
    }
